          ...
          statements: [
            new iam.PolicyStatement({
              ...
              resources: [
                ...
                `arn:aws:bedrock:us-east-1:${process.env.CDK_DEFAULT_ACCOUNT}:inference-profile/us.amazon.nova-pro-v1:0`,
                `arn:aws:bedrock:us-east-2:${process.env.CDK_DEFAULT_ACCOUNT}:inference-profile/us.amazon.nova-pro-v1:0`,
                `arn:aws:bedrock:us-west-2:${process.env.CDK_DEFAULT_ACCOUNT}:inference-profile/us.amazon.nova-pro-v1:0`,
